...
// Type: Qios.DevSuite.Components.Design.QCompositeControlDesigner
...
{
  public class QCompositeControlDesigner : ControlDesigner, IQDragControlDesigner, IQDesigner
  {
    ...
    public bool IsDragging => this.m_bIsDragging;
    ...
    protected override void PreFilterProperties(IDictionary properties)
    {
      ...
      properties.Add((object) "DrawOutlines", (object) TypeDescriptor.CreateProperty(typeof (QCompositeControlDesigner), "DrawOutlines", typeof (bool), (Attribute) new DefaultValueAttribute(true), (Attribute) new DescriptionAttribute("Indicates whether the outline of items must be drawn"), (Attribute) CategoryAttribute.Design, (Attribute) DesignOnlyAttribute.Yes));
    }
