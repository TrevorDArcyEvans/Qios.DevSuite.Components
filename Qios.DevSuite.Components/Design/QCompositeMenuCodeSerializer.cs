...
// Type: Qios.DevSuite.Components.Design.QCompositeMenuCodeSerializer
...
{
  public class QCompositeMenuCodeSerializer : CodeDomSerializer
  {
    public override object Serialize(IDesignerSerializationManager manager, object value)
    {
      if (manager == null)
        throw new InvalidOperationException(QResources.GetException("General_ParameterNull", (object) nameof (manager)));
      QCompositeMenu menu = (QCompositeMenu) value;
      object obj = ((CodeDomSerializer) manager.GetSerializer(typeof (QCompositeMenu).BaseType, typeof (CodeDomSerializer))).Serialize(manager, (object) menu);
      if (obj is CodeStatementCollection statementCollection)
      {
        ...
        QCompositeMenuExtender extenderProviderOnSite = QCompositeMenuDesigner.GetExtenderProviderOnSite(menu.Site, false);
    ...
    public override object Deserialize(IDesignerSerializationManager manager, object codeObject)
    {
      if (manager == null)
        throw new InvalidOperationException(QResources.GetException("General_ParameterNull", (object) nameof (manager)));
      return ((CodeDomSerializer) manager.GetSerializer(typeof (QCompositeMenu).BaseType, typeof (CodeDomSerializer))).Deserialize(manager, codeObject);
    }
  }
}
