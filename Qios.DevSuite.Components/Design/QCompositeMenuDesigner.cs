...
// Type: Qios.DevSuite.Components.Design.QCompositeMenuDesigner
...
{
  public class QCompositeMenuDesigner : ComponentDesigner
  {
    private QCompositeMenu m_oMenu;
    ...
    public override void Initialize(IComponent component)
    {
      ...
      this.m_oMenu = (QCompositeMenu) component;
      ...
      QCompositeMenuDesigner.GetExtenderProviderOnSite(component.Site, true);
    ...
    internal static QCompositeMenuExtender GetExtenderProviderOnSite(
      ISite site,
      bool createWhenNotAvailable)
    {
      if (site == null)
        return (QCompositeMenuExtender) null;
      ...
      if (service1 != null)
      {
        ...
        {
          if (extenderProviders[index] is QCompositeMenuExtender)
            return (QCompositeMenuExtender) extenderProviders[index];
        }
      }
      if (createWhenNotAvailable)
      {
        ...
        if (service2 != null)
        {
          QCompositeMenuExtender provider = new QCompositeMenuExtender();
