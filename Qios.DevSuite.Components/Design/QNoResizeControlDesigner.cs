...
// Type: Qios.DevSuite.Components.Design.QNoResizeControlDesigner
...
{
  public class QNoResizeControlDesigner : ControlDesigner
  {
    ...
    public override void Initialize(IComponent component)
    {
      ...
      this.m_oControl = component as QControl;
