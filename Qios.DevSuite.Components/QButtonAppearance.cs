...
// Type: Qios.DevSuite.Components.QButtonAppearance
...
{
  public class QButtonAppearance : QShapeAppearance
  {
    public QButtonAppearance()
    {
      this.Properties.DefineProperty(16, (object) QShape.BaseShapes[QBaseShapeType.RoundedButton]);
      ...
      this.Properties.DefineProperty(7, (object) 80);
    }
