...
// Type: Qios.DevSuite.Components.QInputBoxButtonShapeAppearance
...
{
  public class QInputBoxButtonShapeAppearance : QShapeAppearance
  {
    public QInputBoxButtonShapeAppearance()
    {
      this.Properties.DefineProperty(16, (object) QShape.BaseShapes[QBaseShapeType.InputBoxRoundedDropDownButton2]);
