...
// Type: Qios.DevSuite.Components.Ribbon.QRibbonCaptionButtonAppearance
...
{
  public class QRibbonCaptionButtonAppearance : QCompositeItemAppearance
  {
    public QRibbonCaptionButtonAppearance()
    {
