...
// Type: Qios.DevSuite.Components.Ribbon.QRibbonTabButtonAppearance
...
{
  public class QRibbonTabButtonAppearance : QTabButtonAppearance
  {
    public QRibbonTabButtonAppearance()
    {
      this.Properties.DefineProperty(16, (object) QShape.BaseShapes[QBaseShapeType.RibbonTabButton]);
